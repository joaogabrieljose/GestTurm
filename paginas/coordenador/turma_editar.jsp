...
try {
    ...
    /* Buscar turma, mas apenas se pertencer ao coordenador */
    psTurma = con.prepareStatement(
        "SELECT " +
        "t.id, t.disciplina_id, t.nome, t.tipo, " +
        "t.capacidade_minima, t.capacidade_maxima, t.ativo, " +
    ...
    psTurma.setInt(2, coordenadorId);
    ...
    /* Buscar apenas disciplinas do coordenador */
...
<head>
    <meta charset="UTF-8">
    <title>Editar Turma - Coordenador</title>
    ...
    <main class="main-content">
        ...
        <header class="topbar">
            <div class="search-box">
                <input type="text" placeholder="Editar turma" disabled>
            </div>
        ...
        <section class="page-header">
            <h1>Editar Turma</h1>
            <p>Atualiza os dados da turma e do horário associado.</p>
        </section>
                ...
                <form action="turma_atualizar.jsp" method="post" class="crud-form">
                    ...
                    <div class="form-grid">
                        ...
                        <div class="form-group">
                            ...
                            <input type="text" name="nome" value="<%= nomeTurma %>" required>
                        </div>
